...
if(userQuery.contains."payment") {
            ...
            if (categoryChoice == 1) {
                ...
                System.out.println("Invalid category choice. Please choose 1 for Payment Methods, 2 for Billing Discrepancies, or 3 for Subscription and Renewal.");
            }
}